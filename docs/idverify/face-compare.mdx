...
- `image1`: first base64-encoded image of user's face for comparison (required)
- `image2`: second base64-encoded image of user's face for comparison (required)
...
```
## **Example Face Compare Verifications**
...
#### Example Verification - Face Compare
